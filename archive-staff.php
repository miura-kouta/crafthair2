            ...
            <ul class="hairStyleCatalog__container">
                <?php while ($the_query->have_posts()) : $the_query->the_post(); ?>
                    <li class="hairStyleCatalog__card">
                        ...
                        <div class="hairStyleCatalog__details">
                            <h2 class="hairStyleCatalog__name"><?php the_field('name'); ?></h2>
                            <p class="hairStyleCatalog__sex"><?php the_field('position'); ?></p>
                            <p class="hairStyleCatalog__sex"><?php the_field('sex'); ?></p>
                            <p class="hairStyleCatalog__sex"><?php the_field('hobby'); ?></p>
                        </div>
                    </li>
                <?php endwhile; ?>
            </ul>
